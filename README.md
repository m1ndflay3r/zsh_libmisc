...
Written in a mixture of both C and pure zsh, this software is capable of executing any ELF binary piped to it without ever actually writing it to a filesystem of any kind. A number of libmiscs' utilities depend on zelfexec for core functionality.
