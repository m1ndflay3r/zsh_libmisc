...
=
# -    zelfexec    -
Arguably the star of the show (which is why it gets its own section in README.md), zelfexec is a more-useful and highly versatile implementation of elfexec by abbat (https://github.com/abbat/elfexec - *used for visual reference only - all of zelfexec's code original*)
